...
rem f:\fpc @extrafpc.cfg corelib\hxdos\fpg_tkit.pas >compile.log
c:\PROGRAMS\FPC\BIN\GO32V2\fpc -dHX_DOS @dosfpc.cfg c:\PROGRAMS\FPC\fpgdos\src\corelib\hxdos\fpg_tkit.pas >compile.log
