...
Type
  ...
  Public
    ...
    Property WindowRect : T_Rect Read GetWindowRect Write SetWindowRect;
...
Function TProcess.GetWindowRect : T_Rect;
begin
  With Result do
    begin
    Left:=dwx;
...
Procedure TProcess.SetWindowRect (Value : T_Rect);
begin
  Include(FStartupOptions,suoUseSize);
  Include(FStartupOptions,suoUsePosition);
  With Value do
