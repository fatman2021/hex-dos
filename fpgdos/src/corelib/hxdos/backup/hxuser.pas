...
function AdjustWindowRect(
 var lpRect : RECT;
  ...
  {$ifdef HX_DOS}
  stdcall; external userdll name 'AdjustWindowRect';
  {$endif}
...
function BeginPaint(Handle: hWnd; Var PS : TPaintStruct) : hdc;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'BeginPaint';
  {$endif}

function BringWindowToTop(wnd: HWND): BOOL;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'BringWindowToTop';
  {$endif}
...
function ClientToScreen(Handle: HWND; P: PPoint) : BOOL;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'ClientToScreen';
  {$endif}

function CloseClipboard: BOOL;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'CloseClipboard';
  {$endif}
...
function CreateCursor(
  ...
  {$ifdef HX_DOS}
  stdcall; external userdll name 'CreateCursor';
  {$endif}
...
function CreateIcon(
  ...
  {$ifdef HX_DOS}
  stdcall; external userdll name 'CreateIcon';
  {$endif}

function CreateIconIndirectD(iconinfo: PICONINFO): HICON;
{$ifdef HX_DOS}
stdcall; external userdll name 'CreateIconIndirect';
{$endif}
...
{$ifdef HX_DOS}
stdcall; external userdll name 'CreateMenu';
{$endif}

function CreatePopupMenu: HMENU;
{$ifdef HX_DOS}
stdcall; external userdll name 'CreatePopupMenu';
{$endif}
...
function CreateWindowEx(dwExStyle: DWORD;
			    ...
			    Instance: HINSTANCE; lpParam: Pointer): HWND;
{$ifdef HX_DOS}
stdcall; external userdll name 'CreateWindowExA';
{$endif}

function DefWindowProc(wnd: HWND; msg: UINT; w: WPARAM; l: LPARAM): LRESULT;
{$ifdef HX_DOS}
stdcall; external userdll name 'DefWindowProcA';
{$endif}
...
function DestroyIconD(Icon: HICON): BOOL;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'DestroyIcon';
  {$endif}

function DeleteMenu(menu: HMENU; uPosition,uFlags: UINT): BOOL;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'DeleteMenu';
  {$endif}

function DestroyMenu(menu: HMENU): BOOL;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'DestroyMenu';
  {$endif}
...
function DestroyWindow(wnd: HWND): BOOL;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'DestroyWindow';
  {$endif}

function DispatchMessage(Message: PMsg): LResult;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'DispatchMessageA';
  {$endif}
...
function DispatchMessageW(Message: PMsg): LResult;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'DispatchMessageW';
  {$endif}
...
function GetClientRect(handle : HWND; var ARect : TRect) : Boolean;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'GetClientRect';
  {$endif}

function GetCursorPos(var lpPoint: TPoint ): Boolean;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'GetCursorPos';
  {$endif}
...
function GetClipboardFormatNameA(
  ...
  {$ifdef HX_DOS}
  stdcall; external userdll name 'GetClipboardFormatNameA';
  {$endif}
...
function GetClipboardOwner: HWND;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'GetClipboardOwner';
  {$endif}

function GetDC(wnd: HWND): HDC;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'GetDC';
  {$endif}
...
function GetFocus: HWND;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'GetFocus';
  {$endif}

function GetKeyState(nVirtKey: Integer): Longint;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'GetKeyState';
  {$endif}

function GetKeyboardState(lpKeystate: PByte): BOOL;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'GetKeyboardState';
  {$endif}


function  GetMessage(var Msg: TMsg; wnd: HWND; wMsgFilterMin,wMsgFilterMax: UINT): Boolean;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'GetMessageA';
  {$endif}

function GetSystemMetrics(nIndex: Integer): Integer;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'GetSystemMetrics';
  {$endif}

function GetWindowLong(wnd: HWND; nIndex: Integer): Longint;
  {$ifdef HX_DOS}
   stdcall; external userdll name 'GetWindowLongA';
  {$endif}
...
: WINDOWPLACEMENT): BOOL;
  {$ifdef HX_DOS}
   stdcall; external userdll name 'GetWindowPlacement';
  {$endif}

function GetWindowRect(Handle: hwnd; var ARect: TRect): BOOL;
  {$ifdef HX_DOS}
   stdcall; external userdll name 'GetWindowRect';
  {$endif}

function GetWindowThreadProcessId(wnd: HWND; lpdwProcessId: LPDWORD): DWORD;
  {$ifdef HX_DOS}
   stdcall; external userdll name 'GetWindowThreadProcessId';
  {$endif}

function InvalidateRect(wnd: HWND; lpr: LPRECT; bErase: BOOL): BOOL;
  {$ifdef HX_DOS}
   stdcall; external userdll name 'InvalidateRect';
  {$endif}

function IsClipBoardFormatAvailable(format: UINT): Boolean;
  {$ifdef HX_DOS}
   stdcall; external userdll name 'IsClipboardFormatAvailable';
  {$endif}
...
function LoadCursorW(Instance: HINSTANCE; lpCursorName
  : LPCWSTR): HCURSOR;
    {$ifdef HX_DOS}
    stdcall; external userdll name 'LoadCursorW';
    {$endif}

function LoadIconA(Instance: HINSTANCE; IconName: LPCSTR): HICON;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'LoadIconA';
  {$endif}
...
function LoadImageA(
   ...
   fuLoad : UINT): HANDLE;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'LoadImageA';
  {$endif}

function MapVirtualKeyA(ucode,uMapType: UINT): UINT;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'MapVirtualKeyA';
  {$endif}

function MapVirtualKeyExA(ucode,uMapType: UINT; dwHkl: HKL): UINT;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'MapVirtualKeyExA';
  {$endif}
...
function MoveWindow(wnd:HWND; x,y,nWidth,hHeight:Integer; bRepaint:BOOL): BOOL;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'MoveWindow';
  {$endif}
...
function PostMessage(HandleWnd: HWND; Msg: Cardinal; w: WParam; l: LParam): Boolean;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'PostMessageA';
  {$endif}
...
function PostThreadMessageW(idThread: DWORD; Msg: UINT; w: WPARAM; l: LPARAM): Boolean;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'PostThreadMessageA';
  {$endif}

procedure PostQuitMessage(nExitCode: Integer);
  {$ifdef HX_DOS}
  stdcall; external userdll name 'PostQuitMessage';
  {$endif}
...
function ReleaseDC(Wnd: HWND; DC: HDC): Integer;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'ReleaseDC';
  {$endif}

function Registerclass(lpWndClass: PWndClass): Word;
function RegisterclassEx(var lpwcx: PWndClassEx): Word;

function RegisterClassA(var lpWndClass: PWndClass): Word;
{$ifdef HX_DOS}
stdcall; external userdll name 'RegisterClassA';
{$endif}

function RegisterClassW(var lpWndClass: PWndClass): Word;
{$ifdef HX_DOS}
stdcall; external userdll name 'RegisterClassW';
{$endif}

function RegisterClassExA(var lpwcx: PWndClassEx): Word;
{$ifdef HX_DOS}
stdcall; external userdll name 'RegisterClassExA';
{$endif}

function RegisterClassExW(var lpwcx: PWndClassEx): Word;
{$ifdef HX_DOS}
stdcall; external userdll name 'RegisterClassExW';
{$endif}
...
function RegisterClipBoardFormatA(
  ...
  {$ifdef HX_DOS}
  stdcall; external userdll name 'RegisterClipBoardFormatA';
  {$endif}
...
function GetClipboardData(uFormat: UINT): HANDLE;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'GetClipboardData';
  {$endif}

function PtInRect(lprc: TRect; point: TPoint): BOOL;
{$ifdef HX_DOS}
stdcall; external userdll name 'PtInRect';
{$endif}

function ScreenToClient(Handle : HWND; P : PPoint) : BOOL;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'ScreenToClient';
  {$endif}

function SendMessage(HandleWnd: HWND; Msg: Cardinal; w: WParam; l: LParam): LResult;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'SendMessageA';
  {$endif}

function SetActiveWindow(wnd: HWND): HWND;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'SetActiveWindow';
  {$endif}
...
function SetTimer(h: HWND; nIDEvent: UINT_PTR; uElapse: UINT; lpTimerFunc: TIMERPROC): UINT_PTR;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'SetTimer';
  {$endif}
...
function SetWindowTextA(wnd: HWND; lpString: LPCSTR): Boolean;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'SetWindowTextA';
  {$endif}

function SetWindowTextW(wnd: HWND; lpString: LPCWSTR): Boolean;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'SetWindowTextW';
  {$endif}

function SetCursor(hCur: HCURSOR): HCURSOR;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'SetCursor';
  {$endif}

function TranslateMessage(Message: PMsg): Boolean;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'TranslateMessage';
  {$endif}
...
function ScrollWindow(Wnd: HWND; dx, dy: Integer; lpRect,lpClipRect: PRect): BOOL;
  {$ifdef HX_DOS}
   stdcall; external userdll name 'ScrollWindow';
  {$endif}
...
function SetClipboardData(uFormat: UINT; hmem: HANDLE = 0): HANDLE;
  {$ifdef HX_DOS}
   external userdll name 'SetClipboardData';
  {$endif}

function SetCursorPos(x,y: Integer): Boolean;
  {$ifdef HX_DOS}
   external userdll name 'SetCursorPos';
  {$endif}

function SetFocus(Wnd: HWND): HWND;
  {$ifdef HX_DOS}
   external userdll name 'SetFocus';
  {$endif}
...
function SetWindowLong(wnd: HWND; nIndex: Integer; dwNewLong: Longint): Longint;
  {$ifdef HX_DOS}
   external userdll name 'SetWindowLongA';
  {$endif}
...
function SetWindowPos(wnd,wndInsertAfter:HWND; x,y,cx,cy:Integer; uFlags: DWORD): Boolean;
  {$ifdef HX_DOS}
   external userdll name 'SetWindowPos';
  {$endif}

function ShowWindow(hWnd: HWND; nCmdShow: Integer): Boolean;
  {$ifdef HX_DOS}
   external userdll name 'ShowWindow';
  {$endif}
...
function UnRegisterClass(lpClassName: LPCSTR; Instance: HINSTANCE): Boolean;
  {$ifdef HX_DOS}
  stdcall; external userdll name 'UnRegisterClassA';
  {$endif}
...
function UpdateWindow(Wnd: HWND): BOOL;
  {$ifdef HX_DOS}
   external userdll name 'UpdateWindow';
  {$endif}

function WindowFromPoint(Point: TPoint): HWND;
  {$ifdef HX_DOS}
   external userdll name 'WindowFromPoint';
  {$endif}
