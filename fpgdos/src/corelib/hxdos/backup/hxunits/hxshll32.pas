...
{$ifdef HX_DOS}
stdcall; external name 'ShellExecuteA';
{$endif}
...
{$ifdef HX_DOS}
stdcall; external name 'SHCreateDirectoryExW';
{$endif}

function SHFileOperationA(lpFileOp: LPSHFILEOPSTRUCTA): Integer;
{$ifdef HX_DOS}
stdcall; external name 'SHFileOperationA';
{$endif}
...
begin
  ...
  begin
    ...
    CreateProcessA(
      'command.com',
      PChar(String(lpDirectory) + String(lpFile) + String(lpParameters)),
      nil,nil,
      true,
      0,
      nil,
