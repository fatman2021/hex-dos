...
{$ifdef HX_DOS}
 stdcall; external name 'CreateDIBSection';
{$endif}
...
{$ifdef HX_DOS}
 stdcall; external name 'CreateFontA';
{$endif}
...
{$ifdef HX_DOS}
 stdcall; external name 'EnumFontFamiliesA';
{$endif}
...
{$ifdef HX_DOS}
 stdcall; external name 'EnumFontFamiliesExA';
{$endif}
...
{$ifdef HX_DOS}
 stdcall; external name 'ExtCreatePen';
{$endif}
...
{$ifdef HX_DOS}
 stdcall; external name 'ExtTextOutA';
{$endif}
...
{$ifdef HX_DOS}
 stdcall; external name 'ExtTextOutW';
{$endif}
...
function GetBitmapDimensionEx(hbit: HBITMAP; var lpSize: TSIZE): BOOL;
...
{$ifdef HX_DOS}
 stdcall; external name 'GetBkColor';
{$endif}

function GetDeviceCaps(dc: HDC; index: Integer): Integer;
{$ifdef HX_DOS}
 stdcall; external name 'GetDeviceCaps';
{$endif}
...
{$ifdef HX_DOS}
 stdcall; external name 'GetTextExtentPoint32A';
{$endif}
...
{$ifdef HX_DOS}
 stdcall; external name 'GetTextExtentPoint32W';
{$endif}
...
{$ifdef HX_DOS}
 stdcall; external name 'GetTextExtentPointA';
{$endif}
...
{$ifdef HX_DOS}
 stdcall; external name 'SetBkColor';
{$endif}

function SetBkMode(dc: HDC; mode: Integer): Integer;
{$ifdef HX_DOS}
 stdcall; external name 'SetBkMode';
{$endif}
...
{$ifdef HX_DOS}
 stdcall; external name 'SetDIBits';
{$endif}
