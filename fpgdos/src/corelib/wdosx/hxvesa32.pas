...
{$ifdef HX_DOS}
stdcall; external vesalib name 'GetVesaModeInfo';
{$endif}

function GetVesaStateBufferSize(): Integer;
{$ifdef HX_DOS}
stdcall; external vesalib name 'GetVesaStateBufferSize';
{$endif}

procedure SetVesaDisplayStart(dwOffset,dwPitch,dwFlags: dword);
{$ifdef HX_DOS}
stdcall; external vesalib name 'SetVesaDisplayStart';
{$endif}

function GetVesaDisplayStart(): dword;
{$ifdef HX_DOS}
stdcall; external vesalib name 'GetVesaDisplayStart';
{$endif}

procedure RestoreVesaVideoState(state: Pointer);
{$ifdef HX_DOS}
stdcall; external vesalib name 'RestoreVesaVideoState';
{$endif}

procedure SaveVesaVideoMemory(mem: Pointer; size: Integer);
{$ifdef HX_DOS}
stdcall; external vesalib name 'SaveVesaVideoMemory';
{$endif}

procedure SaveVesaVideoState(state: Pointer; size: Integer);
{$ifdef HX_DOS}
stdcall; external vesalib name 'SaveVesaVideoState';
{$endif}

function SearchVesamode(xres,yres,bpp: Integer): Integer;
{$ifdef HX_DOS}
stdcall; external vesalib name 'SearchVesamode';
{$endif}

procedure SetVesaMode(mode: Integer);
{$ifdef HX_DOS}
stdcall; external vesalib name 'SetVesaMode';
{$endif}

procedure SetVesaPaletteEntries(dwStart,nEntries: dword; pEntries: Pointer);
{$ifdef HX_DOS}
stdcall; external vesalib name 'SetVesaPaletteEntries';
{$endif}

procedure GetVesaPaetteEntries(dwStart,nEntries: dword; pEntries: Pointer);
{$ifdef HX_DOS}
stdcall; external vesalib name 'GetVesaPaetteEntries';
{$endif}

procedure VesaInit();
{$ifdef HX_DOS}
stdcall; external vesalib name 'VesaInit';
{$endif}

procedure VesaExit();
{$ifdef HX_DOS}
stdcall; external vesalib name 'VesaExit';
{$endif}

procedure SetCursorPaletteEntries(bScreenColor,bCursorColor: dword);
{$ifdef HX_DOS}
stdcall; external vesalib name 'SetCursorPaletteEntries';
{$endif}

procedure VesaMouseInit();
{$ifdef HX_DOS}
stdcall; external vesalib name 'VesaMouseInit';
{$endif}

procedure VesaMouseExit();
{$ifdef HX_DOS}
stdcall; external vesalib name 'VesaMouseExit';
{$endif}
